...
_How many tourist attractions are there in the data set?_ 348
...
_What are the variable data types?_ attraction, n_2021, n_2022, admission, setting, region
...
_Which attraction had the most number of visitors in 2022?_ The Crown Estate, Windsor Great Park
...
_What is the admission charge for the `"National Museum of Scotland"`?_ Free
...
**It means 'not-applicable', and it means that there is a character inside n_2021 that is overriding the format of the variable into characters and not numeric, but the variable must be all in numeric format in order to for the mean() and median() command to be applied to it.**
...
**mean_2021 = 232431, median_2021 = 129829**
...
**It means that the tourism in the UK is concentrated in certain areas and not equally spread out (most likely places like Edinburgh and London), as the majority of the visitors per year are close to the median, but there are several extremely popular tourist sights that have skewed the mean to a much larger value than the median.**
